package com.github.meypod.al_azan.screens.settings.screens.sound
...
@Preview
@Composable
fun NotificationSound(navController: NavController = rememberNavController()) {
            ...
            Column(
                ...
                Column(
                    ...
                    LazyColumn(
                        ...
                        items(listOfNotifications) {
                            ItemOfNotifications(it)
                        }
                    }
                }
...
@Composable
fun ItemOfNotifications(text: String) {
